select
    ...
    count(*) Servidores,
    sum(capa.vlproventos) as Bruto,
    sum(capa.vldescontos) as Descontos,
    sum(nvl(capa.vlproventos, 0) - nvl(capa.vldescontos, 0)) as Liquido
...
order by folha.nuanomesreferencia, capa.flativo, o.sgorgao, 4