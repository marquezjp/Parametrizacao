...
select * from epagnivelrefcefagrup;
select * from epagnivelrefcefagrupversao;
select * from epaghistnivelrefcefagrup;
select * from epaghistnivelrefcarrcefagrup;
select * from epagvalorcarreiracefagrup;
/
