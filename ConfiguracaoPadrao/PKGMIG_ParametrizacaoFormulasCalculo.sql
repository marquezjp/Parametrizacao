...
CREATE OR REPLACE PACKAGE PKGMIG_ParametrizacaoFormulasCalculo AS
  ...
  PROCEDURE pImportar(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  ...
	  pcdRubricaAgrupamento IN NUMBER, pFormulaCalculo IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);
  ...
  PROCEDURE pImportarVersoes(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  psgModulo IN CHAR, psgConceito IN VARCHAR2, pcdIdentificacao IN VARCHAR2,
	  pcdFormulaCalculo IN NUMBER, pVersoesFormula IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);

  PROCEDURE pImportarVigencias(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  psgModulo IN CHAR, psgConceito IN VARCHAR2, pcdIdentificacao IN VARCHAR2,
	  pcdFormulaVersao IN NUMBER, pVigenciasFormula IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);

  PROCEDURE pImportarExpressao(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  psgModulo IN CHAR, psgConceito IN VARCHAR2, pcdIdentificacao IN VARCHAR2,
	  pcdHistFormulaCalculo IN NUMBER, pExpressaoFormula IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);

  PROCEDURE pImportarBlocos(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  psgModulo IN CHAR, psgConceito IN VARCHAR2, pcdIdentificacao IN VARCHAR2,
	  pcdExpressaoFormCalc IN NUMBER, pBlocosFormula IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);

  PROCEDURE pImportarExpressaoBloco(psgAgrupamentoDestino IN VARCHAR2, psgOrgao IN VARCHAR2,
    ptpOperacao IN VARCHAR2, pdtOperacao IN TIMESTAMP,
	  psgModulo IN CHAR, psgConceito IN VARCHAR2, pcdIdentificacao IN VARCHAR2,
	  pcdFormulaCalculoBloco IN NUMBER, pBlocoExpressao IN CLOB, pnuNivelAuditoria IN NUMBER DEFAULT NULL);
